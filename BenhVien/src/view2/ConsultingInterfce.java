...
public class ConsultingInterfce extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ConsultingInterfce frame = new ConsultingInterfce();
	...
	btnReturn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				ReceptionistInterface rep = new ReceptionistInterface();
				rep.main(null);
				setVisible(false);
		...
		btnSave.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if((docDao.updateConsultingFile(u))) {
					...
					ConsultingInterfce cons = new ConsultingInterfce();
					cons.main(null);;
					setVisible(false);
				}
				else {

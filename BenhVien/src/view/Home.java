	...
	public Home() {
		...
		btnLogin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (check) {
					switch (dll.getLogin(u, p)) {
					case 1:
						FReceptionist r = new FReceptionist();
						setVisible(false);
						r.main(null);
						break;
					case 2:
						FDocTor d = new FDocTor();
						setVisible(false);
						d.main(null);
						break;
					case 3:
						...
						a.main(null);break;
					case 4:
						FAddSpecialist s = new FAddSpecialist();
						setVisible(false);
						s.main(null);
						break;
					case 5:
						FAddTest t = new FAddTest();
						setVisible(false);
						t.main(null);break;
					case 6:
						FPharmacist pp = new FPharmacist();
						setVisible(false);
						pp.main(null);break;
					default:
